...
// Fix: Switched to a constructor-based state initialization for the ErrorBoundary component.
// This resolves TypeScript inference issues where 'setState' and 'props' were not recognized on the component instance.
